...
def add_links_to_plan(plan: Dict[str, Any], cas_dir: Path, subfolder_name, links: list[str]) -> tuple[int, int]:
    """Add links to the nested plan structure under the cas_dir name and module-specified subfolder.
    ...
    reports_sf = _ensure_downloads_subfolder(cas_entry, subfolder_name)
